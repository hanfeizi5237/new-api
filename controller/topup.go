...
func GetTopUpInfo(c *gin.Context) {
	...
	// Check if Alipay official payment is enabled
	...
	// Check if WeChat Pay official payment is enabled
	...
	data := gin.H{
		...
		"enable_quota_pay_for_subscription": isQuotaPayForSubscriptionEnabled(),
