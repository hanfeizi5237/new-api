...
原始 `AI_Token集市平台_需求规格说明书.md` 应视为“完整目标愿景”，不是 `M1` 的直接验收单。

当前目录中用于真正指导实施与阶段验收的基线文档为：
...
如果“完整需求说明”和“当前阶段实施文档”存在冲突，`M1` 应以分层基线文档为准；原始需求继续保留为 `Pilot MVP / Marketplace V1` 的目标输入。
