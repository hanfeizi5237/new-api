...
📖 更多部署方式请参考 [部署指南](https://www.cctoken.fun/docs)
...
### 📖 [官方文档](https://www.cctoken.fun/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/new-api)
...
| 分类 | 链接 |
|------|------|
| 🚀 部署指南 | [安装文档](https://www.cctoken.fun/docs) |
| ⚙️ 环境配置 | [环境变量](https://www.cctoken.fun/docs) |
| 📡 接口文档 | [API 文档](https://www.cctoken.fun/docs) |
| ❓ 常见问题 | [FAQ](https://www.cctoken.fun/docs) |
| 💬 社区交流 | [交流渠道](https://www.cctoken.fun/docs) |

---

## ✨ 主要特性

> 详细特性请参考 [特性说明](https://www.cctoken.fun/docs)
...
> 详情请参考 [接口文档 - 网关接口](https://www.cctoken.fun/docs)

| 模型类型 | 说明 | 文档 |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI 兼容模型 | [文档](https://www.cctoken.fun/docs) |
| 🤖 OpenAI Responses | OpenAI Responses 格式 | [文档](https://www.cctoken.fun/docs) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [文档](https://www.cctoken.fun/docs) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [文档](https://www.cctoken.fun/docs) |
| 🔄 Rerank | Cohere、Jina | [文档](https://www.cctoken.fun/docs) |
| 💬 Claude | Messages 格式 | [文档](https://www.cctoken.fun/docs) |
| 🌐 Gemini | Google Gemini 格式 | [文档](https://www.cctoken.fun/docs) |
| 🔧 Dify | ChatFlow 模式 | - |
...
- [响应接口 (Responses)](https://www.cctoken.fun/docs)
- [图像接口 (Image)](https://www.cctoken.fun/docs)
- [音频接口 (Audio)](https://www.cctoken.fun/docs)
- [视频接口 (Video)](https://www.cctoken.fun/docs)
- [嵌入接口 (Embeddings)](https://www.cctoken.fun/docs)
- [重排序接口 (Rerank)](https://www.cctoken.fun/docs)
- [实时对话 (Realtime)](https://www.cctoken.fun/docs)
...
📖 **完整配置：** [环境变量文档](https://www.cctoken.fun/docs)
...
| 📘 常见问题 | [FAQ](https://www.cctoken.fun/docs) |
| 💬 社区交流 | [交流渠道](https://www.cctoken.fun/docs) |
| 🐛 反馈问题 | [问题反馈](https://www.cctoken.fun/docs) |
| 📚 完整文档 | [官方文档](https://www.cctoken.fun/docs) |
...
**[官方文档](https://www.cctoken.fun/docs)** • **[问题反馈](https://github.com/Calcium-Ion/new-api/issues)** • **[最新发布](https://github.com/Calcium-Ion/new-api/releases)**
