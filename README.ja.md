...
📖 その他のデプロイ方法については[デプロイガイド](https://www.cctoken.fun/docs)を参照してください。
...
### 📖 [公式ドキュメント](https://www.cctoken.fun/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/new-api)
...
| カテゴリ | リンク |
|------|------|
| 🚀 デプロイガイド | [インストールドキュメント](https://www.cctoken.fun/docs) |
| ⚙️ 環境設定 | [環境変数](https://www.cctoken.fun/docs) |
| 📡 APIドキュメント | [APIドキュメント](https://www.cctoken.fun/docs) |
| ❓ よくある質問 | [FAQ](https://www.cctoken.fun/docs) |
| 💬 コミュニティ交流 | [交流チャネル](https://www.cctoken.fun/docs) |

---

## ✨ 主な機能

> 詳細な機能については[機能説明](https://www.cctoken.fun/docs)を参照してください。
...
- ⚡ [OpenAI Realtime API](https://www.cctoken.fun/docs)（Azureを含む）
- ⚡ [Claude Messages](https://www.cctoken.fun/docs)
- ⚡ [Google Gemini](https://www.cctoken.fun/docs)
- 🔄 [Rerankモデル](https://www.cctoken.fun/docs)（Cohere、Jina）
...
> 詳細については[APIドキュメント - ゲートウェイインターフェース](https://www.cctoken.fun/docs)

| モデルタイプ | 説明 | ドキュメント |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI互換モデル | [ドキュメント](https://www.cctoken.fun/docs) |
| 🤖 OpenAI Responses | OpenAI Responsesフォーマット | [ドキュメント](https://www.cctoken.fun/docs) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [ドキュメント](https://www.cctoken.fun/docs) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [ドキュメント](https://www.cctoken.fun/docs) |
| 🔄 Rerank | Cohere、Jina | [ドキュメント](https://www.cctoken.fun/docs) |
| 💬 Claude | Messagesフォーマット | [ドキュメント](https://www.cctoken.fun/docs) |
| 🌐 Gemini | Google Geminiフォーマット | [ドキュメント](https://www.cctoken.fun/docs) |
| 🔧 Dify | ChatFlowモード | - |
...
- [チャットインターフェース (Chat Completions)](https://www.cctoken.fun/docs)
- [レスポンスインターフェース (Responses)](https://www.cctoken.fun/docs)
- [イメージインターフェース (Image)](https://www.cctoken.fun/docs)
- [オーディオインターフェース (Audio)](https://www.cctoken.fun/docs)
- [ビデオインターフェース (Video)](https://www.cctoken.fun/docs)
- [エンベッドインターフェース (Embeddings)](https://www.cctoken.fun/docs)
- [再ランク付けインターフェース (Rerank)](https://www.cctoken.fun/docs)
- [リアルタイム対話インターフェース (Realtime)](https://www.cctoken.fun/docs)
- [Claudeチャット](https://www.cctoken.fun/docs)
- [Google Geminiチャット](https://www.cctoken.fun/docs)
...
📖 **完全な設定:** [環境変数ドキュメント](https://www.cctoken.fun/docs)
...
| 📘 よくある質問 | [FAQ](https://www.cctoken.fun/docs) |
| 💬 コミュニティ交流 | [交流チャネル](https://www.cctoken.fun/docs) |
| 🐛 問題のフィードバック | [問題フィードバック](https://www.cctoken.fun/docs) |
| 📚 完全なドキュメント | [公式ドキュメント](https://www.cctoken.fun/docs) |
...
**[公式ドキュメント](https://www.cctoken.fun/docs)** • **[問題フィードバック](https://github.com/Calcium-Ion/new-api/issues)** • **[最新リリース](https://github.com/Calcium-Ion/new-api/releases)**
